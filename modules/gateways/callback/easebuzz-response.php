...
$gatewaymodule = "easebuzz"; # Enter your gateway module name here replacing template
...
$invoiceid = checkCbInvoiceID($invoiceid, 'easebuzz'); # Checks invoice ID is a valid invoice number or ends processing
...
if($response['status']=='success') {
    ...
    //logTransaction($GATEWAY["name"],$response,"Unsuccessful"); # Save to Gateway Log: name, data array, status
     ...
     // path of your viewinvoice.php
$filename = $GATEWAY['systemurl'].'/viewinvoice.php?id=' . $invoiceid;
